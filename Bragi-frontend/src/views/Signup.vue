        ...
        <el-col :span="12">
          ...
          <el-form ref="Form" :model="formData" @keyup.enter.native="handleLogin" :rules="formRules">
            ...
            <el-form-item prop="confirm_password" :rules="formRules.confirm_password">
              <el-input class="box-input" type="password" v-model="formData.confirm_password" placeholder="确认密码" />
            </el-form-item>
            ...
            <div class="verify-area">
              ...
              <el-button class="email-verify-btn" :loading="codeLoading" :disabled="isDisable" size="small" round
                @click="sendMsg()">邮箱验证
              </el-button>
            </div>
            <div>
