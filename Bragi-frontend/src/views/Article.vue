        ...
        <el-container style="max-width: 1300px; margin:auto">
            ...
            <el-container>
                <el-aside v-show="showAllArticles " class="lined" style="width:350px">
                    ...
                    <div class="artileItem" v-for="item of articleList" :key="item.articleId"
                         @click="switchToArticle(item.articleId)">
                ...
                <el-aside v-show="showOutline " class="lined">
                    ...
                    <div id="outline" style="display:block"></div>
                </el-aside>
...
export default {
    ...
    methods: {
        ...
        fetchTitle() {
            ...
            axios.get('/api/title')
                .then(response => {
                    this.title = response.data.title; // 更新标题数据
                })
                .catch(error => {
        ...
        refreshCache() {
            ...
            const cacheUrl = `/api/data`;

            axios.get(cacheUrl)
                .then(response => {
                    console.log('缓存已刷新');
                    this.fetchTitle(); // 缓存刷新成功后重新加载标题
                })
                .catch(error => {
