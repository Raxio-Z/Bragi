  ...
  <div>
    <el-form ref="form" label-width="140px">
      ...
      <el-form-item v-if="editorConfig.enableHighLight" label="代码样式">
        ...
        <el-link style="padding-left: 5px" :underline="false"
                 href="https://xyproto.github.io/splash/docs/longer/all.html" target="_blank">样式参考
        </el-link>
      </el-form-item>
      ...
      <el-form-item v-if="editorConfig.enableCustomStyle" label="编辑器样式路径">
        ...
        <el-link style="padding-left: 5px" :underline="false"
                 href="https://github.com/Hansanshi/mark-idea-front/blob/main/src/assets/vditor.css" target="_blank">
          样式参考
        </el-link>
      </el-form-item>

      <el-form-item>
        <el-button type="success" @click="handleSaveEditorConfig">保存</el-button>
...
export default {
  ...
  mounted()
  {
    console.log("editorsetting mounted")
    ...
    handleSaveEditorConfig() {
      ...
      // axios.post(global.HOST_URL + "/user/updateEditorConfig", this.editorConfig, this.config).then(res => {
        ...
        if (res.code === 0) {
          ...
          console.log(this.editorConfig.editMode)
