        ...
        <el-table
            ...
            >
                <template slot-scope="scope">
                    ...
                    <a :href='"/file/" + config.headers.username + "/" + scope.row.fileName '
                       style="padding-right: 10px" target="_blank">预览</a>
...
export default {
    ...
    methods: {
        ...
        handleFileUpload() {
            ...
            param.append('notebookname', 'notebook')
            param.append('notename', 'note')
            let config = {
                headers: {
